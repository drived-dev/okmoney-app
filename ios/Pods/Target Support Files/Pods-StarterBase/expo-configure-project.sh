...
with_node \
  ...
  --target "/Users/melchanatan/Documents/AppDevelopment/okmoney-app/ios/Pods/Target Support Files/Pods-StarterBase/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-router" "expo-system-ui"
