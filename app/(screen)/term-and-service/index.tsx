...
const demodata: Term = {
  description: (
    <>
      ...
      ข้อตกลงการให้สิทธิ์การใช้งานสำหรับผู้ใช้แอปพลิเคชัน 1.
      การให้สิทธิ์การใช้งาน -
      ผู้พัฒนาให้สิทธิ์การใช้งานแอปพลิเคชันนี้แก่ผู้ใช้ในลักษณะ ไม่ผูกขาด
      ไม่สามารถโอนสิทธิ์ และสามารถเพิกถอนได้
      สำหรับวัตถุประสงค์ส่วนบุคคลหรือทางธุรกิจ
      ภายใต้เงื่อนไขที่กำหนดไว้ในข้อตกลงฉบับนี้ - ผู้ใช้ ไม่มีสิทธิ์ในการแจกจ่าย
      คัดลอก แก้ไข วิศวกรรมย้อนกลับ หรือสร้างแอปพลิเคชันอื่น
      จากแอปนี้ไม่ว่าทั้งหมดหรือบางส่วน 2. การจัดเก็บและการใช้งานข้อมูล -
      ข้อมูลที่ผู้ใช้กรอกเข้าสู่ระบบ เช่น ชื่อ หมายเลขโทรศัพท์ ยอดหนี้
      และวันครบกำหนดชำระ จะถูกจัดเก็บบนเซิร์ฟเวอร์ของผู้ให้บริการฐานข้อมูล
      โดยอยู่ภายใต้นโยบายความปลอดภัยและความเป็นส่วนตัวของผู้พัฒนา -
      ผู้ใช้เป็นผู้รับผิดชอบโดยตรงต่อความถูกต้องและความเหมาะสมของข้อมูลทั้งหมดที่กรอกเข้าระบบ
      - ผู้พัฒนา จะไม่ขาย แบ่งปัน หรือเผยแพร่ข้อมูลของผู้ใช้แก่บุคคลภายนอก
      เว้นแต่จะได้รับความยินยอมอย่างชัดแจ้งจากผู้ใช้ก่อนล่วงหน้า 3.
      ความรับผิดชอบของผู้ใช้ - ผู้ใช้ต้องใช้งานแอปพลิเคชันนี้
      ภายใต้กรอบของกฎหมายท้องถิ่นที่เกี่ยวข้อง
      โดยเฉพาะกฎหมายว่าด้วยการให้กู้ยืมและการติดต่อลูกหนี้ในประเทศของตน -
      ผู้พัฒนา ไม่รับผิดชอบต่อผลกระทบทางกฎหมาย ที่เกิดจากการใช้งานฟีเจอร์ระบบ
      SMS ทวงหนี้อัตโนมัติของผู้ใช้
      โดยผู้ใช้ต้องได้รับความยินยอมจากผู้รับข้อความตามที่กฎหมายกำหนด 4.
      บริการและการอัปเดต - ผู้พัฒนาอาจดำเนินการอัปเดตแอปพลิเคชันเป็นระยะ
      เพื่อปรับปรุงฟังก์ชัน ความปลอดภัย และประสบการณ์การใช้งาน -
      ผู้ใช้ตกลงให้สิทธิ์แก่ผู้พัฒนาในการดำเนินการอัปเดตแอปโดยอัตโนมัติหากเห็นว่าจำเป็น
      5. ข้อจำกัดความรับผิด - แอปพลิเคชันนี้ให้บริการในลักษณะ
      "ตามสภาพที่เป็นอยู่" (As-is) โดยไม่มีการรับประกันใด ๆ
      ทั้งโดยชัดแจ้งหรือโดยนัย รวมถึงแต่ไม่จำกัดเพียง ความถูกต้อง ความเสถียร
      หรือความเหมาะสมกับวัตถุประสงค์เฉพาะ - ผู้พัฒนา
      ไม่รับผิดชอบต่อความเสียหายใด ๆ ที่เกิดขึ้นจากการใช้งานแอป ไม่ว่าจะโดยตรง
      โดยอ้อม หรือโดยบังเอิญ 6. การยกเลิกสิทธิ์การใช้งาน -
      หากผู้ใช้ละเมิดเงื่อนไขในข้อตกลงฉบับนี้ สิทธิ์ในการใช้งานจะถูก
      เพิกถอนโดยทันที โดยไม่ต้องแจ้งให้ทราบล่วงหน้า - การยกเลิกสิทธิ์การใช้งานจะ
      ไม่ยกเว้นความรับผิดใด ๆ ที่เกิดขึ้นก่อนหน้านั้น 7. ข้อกฎหมายที่ใช้บังคับ -
      ข้อตกลงฉบับนี้อยู่ภายใต้บังคับของกฎหมายของประเทศที่ผู้พัฒนามีถิ่นที่อยู่ทางธุรกิจ
      และข้อพิพาทใด ๆ
      ที่เกิดขึ้นจะต้องพิจารณาโดยศาลที่มีเขตอำนาจตามกฎหมายของประเทศดังกล่าว 8.
      ข้อตกลงเพิ่มเติมเกี่ยวกับการส่งข้อความ (SMS) -
      แอปพลิเคชันนี้มีฟีเจอร์สำหรับการส่งข้อความ SMS
      ไปยังลูกหนี้ตามข้อมูลที่ผู้ใช้กำหนด
      ผู้ใช้เป็นผู้รับผิดชอบโดยตรงในการตรวจสอบความถูกต้องของข้อมูล
      และต้องได้รับความยินยอมอย่างชัดแจ้งจากผู้รับข้อความ - ผู้พัฒนา
      ไม่มีส่วนเกี่ยวข้องหรือรับผิดชอบต่อผลทางกฎหมายใด ๆ
      ที่เกิดจากการส่งข้อความโดยผู้ใช้ 9. ข้อตกลงฉบับสมบูรณ์ -
      ข้อตกลงฉบับนี้ถือเป็นข้อตกลงฉบับสมบูรณ์ระหว่างผู้ใช้และผู้พัฒนา
      หากข้อกำหนดใดในข้อตกลงนี้ถูกตัดสินให้เป็นโมฆะ หรือไม่สามารถบังคับใช้ได้
      เงื่อนไขอื่น ๆ ที่เหลือยังคงมีผลบังคับใช้อย่างเต็มที่ 10.
      การชำระเงินและการสมัครสมาชิก (In-App Purchases and Subscriptions)
      แอปพลิเคชันนี้ให้บริการบางส่วนในรูปแบบของ การสมัครสมาชิกแบบชำระเงิน
      (Subscription) เพื่อเข้าถึงฟีเจอร์พิเศษ เช่น: การส่งข้อความ SMS
      อัตโนมัติแบบไม่จำกัด การสำรองข้อมูลอัตโนมัติ การวิเคราะห์รายงานขั้นสูง
      ประเภทของแผนการสมัครสมาชิก Small Plan (รายเดือน) Medium Plan (รายเดือน)
      Large Plan (รายเดือน) การต่ออายุอัตโนมัติ
      แผนการสมัครสมาชิกทั้งหมดจะต่ออายุโดยอัตโนมัติ
      เว้นแต่ผู้ใช้ดำเนินการยกเลิกอย่างน้อย 24
      ชั่วโมงก่อนถึงวันหมดอายุของรอบปัจจุบัน การเรียกเก็บเงิน
      ค่าบริการจะถูกเรียกเก็บโดย Apple ผ่านบัญชี Apple ID ที่เชื่อมกับ App Store
      โดยอัตโนมัติ การจัดการการสมัครสมาชิก
      ผู้ใช้สามารถจัดการหรือยกเลิกการสมัครสมาชิกได้ด้วยตนเองผ่าน: Settings {">"}{" "}
      Apple ID {">"} Subscriptions การยกเลิกการสมัครสมาชิก
      การยกเลิกจะไม่มีผลย้อนหลัง
      และผู้ใช้ยังสามารถใช้ฟีเจอร์ที่ชำระเงินแล้วได้จนกว่าจะสิ้นสุดรอบการเรียกเก็บเงินปัจจุบัน
      นโยบายการคืนเงิน การชำระเงินทั้งหมดอยู่ภายใต้นโยบายการคืนเงินของ Apple
      Inc. หากต้องการขอคืนเงิน ผู้ใช้สามารถดำเนินการได้ผ่าน:
...
const Index = () => {
  ...
  const handleNextPage = async () => {
    ...
    if (allSuccess && responses[0].status === 200) {
